...
# 加载数据集
train_data = pd.read_csv('train12-t5.csv')  # 替换为正确的文件路径
test_data = pd.read_csv('test12-t5.csv')    # 替换为正确的文件路径

# 选定的特征
selected_features = ['copolymer', 'A3431531268', 'A864662311', 'A3975295864', 'A4216335232',
                     'A3217380708', 'A951226070', 'G994485099', 'G2976033787']
...
# train_predictions.to_csv('train_predictions-ts-tt15-14.csv', index=False)
# test_predictions.to_csv('test_predictions-ts-tt15-14.csv', index=False)
